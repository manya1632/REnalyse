  ...
  return (
    <nav className="w-full py-5 px-6 md:px-12 flex justify-between items-center bg-transparent absolute top-0 z-50">
      ...
      <div className="hidden md:flex items-center space-x-8 font-medium text-renalyse-dark">
        ...
        <button className="bg-renalyse-primary text-white px-6 py-2.5 rounded-full font-semibold shadow-md hover:shadow-lg transition transform hover:-translate-y-0.5 cursor-pointer">
          Portal Login
        </button>
      </div>
    </nav>
